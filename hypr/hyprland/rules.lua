...
hl.layer_rule({ match = { namespace = "quickshell:actionCenter" }, animation = "fade"})
...
hl.layer_rule({ match = { namespace = "quickshell:polkit" }, animation = "fade"})
...
hl.layer_rule({ match = { namespace = "quickshell:wNotificationCenter" }, animation = "slide right"})
hl.layer_rule({ match = { namespace = "quickshell:wOnScreenDisplay" }, animation = "fade"})
hl.layer_rule({ match = { namespace = "quickshell:wStartMenu" }, animation = "popin 96%"})
hl.layer_rule({ match = { namespace = "quickshell:wTaskView" }, ignore_alpha = 0})
hl.layer_rule({ match = { namespace = "quickshell:wTaskView" }, animation = "fade"})
