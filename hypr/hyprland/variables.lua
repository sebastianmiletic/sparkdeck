...
settingsApp = "~/.config/hypr/custom/scripts/toggle-settings.sh"
taskManager = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'gnome-system-monitor' 'command -v btop && kitty -1 fish -c btop'"
