...
ApplicationWindow {
    id: root
    readonly property bool preloadMode: Quickshell.env("II_SETTINGS_PRELOAD") === "1"
    ...
    property var pages: [
        ...
        },
        {
            ...
            icon: "school",
            component: "modules/settings/ProductivityConfig.qml"
        },
        {
    ...
    visible: !preloadMode
    onClosing: event => {
        // Keep this small settings process warm. Reopening it through Super+I
        // is then an IPC round trip instead of another full QML startup.
    ...
    ColumnLayout {
        ...
        RowLayout { // Window content with navigation rail and content pane
            ...
            Item {
                ...
                Layout.fillHeight: true
                Layout.margins: 5
                implicitWidth: navRail.expanded ? 170 : fab.baseSize
