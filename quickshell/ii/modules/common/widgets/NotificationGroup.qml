...
MouseArea { // Notification group area
    ...
    property bool critical: root.notifications.some(n => n.urgency === NotificationUrgency.Critical.toString())
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        color: root.containsMouse ? Appearance.colors.colLayer2Hover : (popup ? Appearance.colors.colBackgroundSurfaceContainer : Appearance.colors.colLayer2)
        radius: Appearance.rounding.normal
        border.width: 1
        border.color: root.critical ? Appearance.colors.colError : Appearance.colors.colLayer0Border
