...
Singleton {
	...
	property string classSchedulePath: FileUtils.trimFileProtocol(`${Directories.state}/user/class-schedule.json`)
	property string googleTasksConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/illogical-impulse/google-tasks`)
