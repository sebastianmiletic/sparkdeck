...
Singleton {
    ...
    sizes: QtObject {
        property real baseBarHeight: 42
        ...
        property real wallpaperSelectorWidth: 880
        property real wallpaperSelectorHeight: 380
        property real wallpaperSelectorItemMargins: 6
        property real wallpaperSelectorItemPadding: 4
    }
