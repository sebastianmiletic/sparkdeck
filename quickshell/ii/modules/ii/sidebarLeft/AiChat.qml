...
Item {
    ...
    function quotaLimit(modelId) {
        ...
        if (key === "gemma-4-31b-it" || key === "gemma-3-27b-it") return 14400;
        if (key === "gemini-2.5-flash-lite") return 1000;
        if (key === "gemini-2.5-flash") return 250;
        if (key === "gemini-2.0-flash" || key === "gemini-2.0-flash-lite") return 200;
        if (key === "gemini-3.5-flash-lite" || key === "gemini-3.1-flash-lite") return 500;
        if (key === "gemini-3-flash" || key === "gemini-3.6-flash" || key === "gemini-3.7-flash") return 20;
        return -1;
    }
