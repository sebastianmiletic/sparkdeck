...
DialogListItem {
    ...
    enabled: !(Network.wifiConnectTarget === root.wifiNetwork && !wifiNetwork?.active && !wifiNetwork?.askingPassword)
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout { // Password
            ...
            MaterialTextField {
                ...
                placeholderText: Translation.tr("Username or identity")
            ...
            MaterialTextField {
                ...
                onAccepted: {
                    if (!root.wifiNetwork.isEnterprise || usernameField.text.length > 0)
            ...
            RowLayout {
                ...
                DialogButton {
                    ...
                    onClicked: {
                        usernameField.text = "";
                        passwordField.text = "";
                        Network.cancelWifiConnection(root.wifiNetwork);
                    }
                }

                DialogButton {
                    buttonText: Translation.tr("Connect")
                    enabled: passwordField.text.length > 0 && (!root.wifiNetwork.isEnterprise || usernameField.text.length > 0)
                    onClicked: {
                        Network.changePassword(root.wifiNetwork, passwordField.text, usernameField.text);
                    }
                }
